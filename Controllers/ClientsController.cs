...
namespace CoderByte.Controllers
{
    public class ClientsController : Controller
    {
        ...
        {
            ViewBag.RegionID = new SelectList(db.Regions, "Id", "Location");
            return View();
        }
        ...
        public ActionResult Create([Bind(Include = "Id,Name,RegionID")] Client client)
        {
            ...
            ViewBag.RegionID = new SelectList(db.Regions, "Id", "Location", client.RegionID);
            return View(client);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Name,RegionID")] Client client)
        {
            if (ModelState.IsValid)
            {
